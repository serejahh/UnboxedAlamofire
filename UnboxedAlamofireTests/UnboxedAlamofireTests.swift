...
class UnboxedAlamofireTests: XCTestCase {
    ...
    func test_mapObject() {
        let url = "fixtures/test_object.json"
    ...
    func test_mapObjectWithKeyPath() {
        let url = "fixtures/test_object_keypath.json"
        let expectation = expectationWithDescription("\(url)")
    ...
    func test_mapObjectWithNestedKeyPath() {
        let url = "fixtures/test_object_nested_keypath.json"
        let expectation = expectationWithDescription("\(url)")
    ...
    func test_mapArray() {
        let url = "fixtures/test_array.json"
        let expectation = expectationWithDescription("\(url)")
    ...
    func test_mapArrayWithKeyPath() {
        let url = "fixtures/test_array_keypath.json"
        let expectation = expectationWithDescription("\(url)")
    ...
    func test_mapArrayWithNestedKeyPath() {
        let url = "fixtures/test_array_nested_keypath.json"
        let expectation = expectationWithDescription("\(url)")
